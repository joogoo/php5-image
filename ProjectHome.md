...
PHP5 Image is a full object-oriented library for an image manipulation by PHP and GD2. It is an extended version of [php-image](http://code.google.com/p/php-image/) project and can be used either standalone or inside [Zend Framework](http://framework.zend.com/) projects.

The project currently provides readers for PNG, JPEG, GIF, PSD, ICO image-file types, and outputs all GD2-supported types.

<img src='https://php5-image.googlecode.com/svn/wiki/php5-image.png' />
